<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_table.aspx.cs" Inherits="RoyalEnfield.admin_table" %>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               <a href="#" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-motorcycle me-2">Royal Endfield</i></h3>
                </a>
