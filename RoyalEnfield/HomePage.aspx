<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="RoyalEnfield.HomePage" %>
...
<body>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <%--<a href="booking.aspx" class="dropdown-item">Bike Booking</a>--%>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img  width="1570px" height="680px" src="Images/home.jpeg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3"></h4>
                            <h1 class="display-1 text-white mb-md-4">Best Bikes In Your Location</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img width="1570px" height="680px" src="Images/home-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3"></h4>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Royal Enfield <span class="text-primary">History</span></h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="Images/g-4.jpeg" alt="">
                    <p>Welcome to Royal Enfield, a legendary motorcycle brand with over a century of history and heritage. Our company was founded in the UK in 1901 and has since become a global leader in the motorcycle industry..</p>
                    <p>We take pride in our unique style and design, offering classic and retro-style motorcycles that are loved by riders all over the world. Our bikes are known for their powerful engines, smooth handling, and unmistakable sound. We strive to produce motorcycles that evoke a sense of adventure, freedom, and individuality, allowing riders to experience the thrill of the open road</p>
                    <p>With a passion for innovation and a commitment to excellence, we continue to push the boundaries of motorcycle design and technology. Our commitment to quality and customer satisfaction is unwavering, and we strive to provide the best possible experience for our customers.
                       Whether you're a seasoned rider or just starting out, we invite you to join the Royal Enfield community and experience the thrill of riding one of our legendary motorcycles.</p>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-secondary p-4 mb-4" style="height: 150px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary ml-n4 mr-4" style="width: 100px; height: 100px;">
                            ...
                            <i class="fa fa-2x fa-bicycle text-secondary"></i>
                        </div>
                        <h4 class="text-light text-uppercase m-0">Test Ride at Your Location</h4>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">We are Everywhere</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Find Your Bikes</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="Images/1.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Bullet 350</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                            </div>
                        ...
                        <a class="btn btn-primary px-3" href="#">2,50,000</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        <img class="img-fluid mb-4" src="Images/2.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Intercepter 650</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a class="btn btn-primary px-3" href="#">3,50,000</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="Images/3.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Himalayan</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="Images/4.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Continental GT 650</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="Images/5.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Classic 350</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a class="btn btn-primary px-3" href="#">2,00,000</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="Images/6.jpeg" alt="">
                        <h4 class="text-uppercase mb-4">Hunter 350</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-bicycle text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a class="btn btn-primary px-3" href="#">2,20,000</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    ...
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Meet Soni</h4>
                        <p class="m-0">CTO</p>
                ...
                <div class="team-item">
                    ...
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Sherya Panchal</h4>
                        <p class="m-0">COO</p>
                        <div class="team-social position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    ...
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Dhaval Gohel</h4>
                        <p class="m-0">CEO</p>
                        <div class="team-social position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4" src="Images/b-1.png" alt="">
                        <div class="text-right">
                            <h3 class="text-uppercase text-light mb-3">History</h3>
                            <p class="mb-4">Royal Enfield is a motorcycle brand that has been around for over a century, and their bikes have become an icon of classic style and rugged durability.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
                        <div class="text-left">
                            ...
                            <p class="mb-4"> In terms of performance, the rider finds the bike to be reliable and powerful enough for their needs, with a smooth ride that makes it comfortable for long trips</p>
                        </div>
                        <img class="img-fluid flex-shrink-0 mr-n5 w-50 ml-4" src="Images/b-2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                            <div class="row">
                                <div class="col-6 form-group">
                                    <asp:TextBox class="form-control p-4" ID="user_contact" MaxLength="50" PlaceHolder="Name" runat="server" required="required"/>
                                </div>
                                <div class="col-6 form-group">
                                    <asp:TextBox class="form-control p-4" ID="email_contact" MaxLength="50" PlaceHolder="Email" runat="server" TextMode="Email" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                               <asp:TextBox class="form-control p-4" ID="subject_contact" MaxLength="50" PlaceHolder="Subject" runat="server" required="required"/>
                            </div>
                            <div class="form-group">
                               <asp:TextBox class="form-control py-3 px-4" ID="message_contact" MaxLength="50" PlaceHolder="Message" runat="server" TextMode="Multiline" required="required"/>
                            </div>
                            <div>
                               <asp:Button class="btn btn-primary py-3 px-5" ID="button_contact" Text="Send Message" runat="server" OnClick="button_Message" />
                            </div>
                    ...
                    <div class="bg-secondary d-flex flex-column justify-content-center px-5 mb-4" style="height: 435px;">
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                ...
                                <p> 66, Paramahansa Yogananda Rd, Eshwara Layout, Indiranagar, Bengaluru, Karnataka 560038</p>
                            </div>
                        </div>
                        <div class="d-flex mb-3">
                            <i class="fa fa-2x fa-map-marker-alt text-primary flex-shrink-0 mr-3"></i>
                            <div class="mt-n1">
                                ...
                                <p> A33, Orchid woods, Corporate Rd, opp. S&P Global, Ahmedabad, Gujarat 380051</p>
                            </div>
                        </div>
                        <div class="d-flex mb-3">
