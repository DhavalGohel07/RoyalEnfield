                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 form-group">
                                 ...
                                 <asp:TextBox ID="b_country" class="form-control p-4" MaxLength="50" PlaceHolder="Country" runat="server" required />
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-6 form-group">
                                 <asp:TextBox ID="b_date" class="form-control p-4" MaxLength="50" runat="server"  Textmode="Date" required/>
                            </div>
                        </div>
